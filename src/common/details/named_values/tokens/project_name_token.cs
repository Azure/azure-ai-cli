...
namespace Azure.AI.Details.Common.CLI
{
    public class ProjectNameToken
    {
        ...
        public static INamedValueTokenParser Parser(bool requireProjectPart = true) => new NamedValueTokenParser(_optionName, _fullName, requireProjectPart ? "010" : "010;001", "1");
