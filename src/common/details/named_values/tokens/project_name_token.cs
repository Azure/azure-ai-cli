...
namespace Azure.AI.Details.Common.CLI
{
    public class ProjectNameToken
    {
        ...
        public static INamedValueTokenParser Parser(bool requireProjectPart = true) => new Any1ValueNamedValueTokenParser(_optionName, _fullName, requireProjectPart ? "010" : "010;001");
