...
namespace Azure.AI.Details.Common.CLI
{
    public class FlowNameToken
    {
        ...
        private const string _requiredDisplayName = "flow name";
        private const string _optionName = "--flow-name";
        private const string _optionExample = "NAME";
        private const string _fullName = "flow.name";
    }
}
