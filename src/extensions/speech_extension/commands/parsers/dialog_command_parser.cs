        ...
        private static INamedValueTokenParser[] botCommandParsers =
         {
            ...
            new Any1ValueNamedValueTokenParser("--botId", "dialog.bot.id", "001"),
            ...
            new RequiredValidValueNamedValueTokenParser("--recognize", "recognize.method", "10", "keyword;continuous;once"),
        ...
        private static INamedValueTokenParser[] ccCommandParsers =
         {
            ...
            /* DialogServiceConfig Parameters*/
            new Any1ValueNamedValueTokenParser("--appId", "dialog.customcommands.appid", "001"),
            ...
            new Any1or2ValueNamedValueTokenParser("--property", "config.string.property", "01"),
