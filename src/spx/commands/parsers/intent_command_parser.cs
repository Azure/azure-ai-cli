...
namespace Azure.AI.Details.Common.CLI
{
    class IntentCommandParser : CommandParser
    {
        ...
        private static INamedValueTokenParser[] intentCommandParsers = {
            ...
            new NamedValueTokenParser(null, "output.all.recognizer.recognized.result.intentid", "100001", "1;0", "true;false", null, "true"),
            new NamedValueTokenParser(null, "output.each.recognizer.recognized.result.intentid", "110001", "1;0", "true;false", null, "true"),

            new NamedValueTokenParser(null, "output.all.result.intentid", "1101", "1;0", "true;false", null, "true"),
            new NamedValueTokenParser(null, "output.each.result.intentid", "1101", "1;0", "true;false", null, "true"),

            new NamedValueTokenParser(null, "output.all.recognizer.recognized.result.luis.json", "1000011", "1;0", "true;false", null, "true"),
            new NamedValueTokenParser(null, "output.each.recognizer.recognized.result.luis.json", "1100011", "1;0", "true;false", null, "true"),

            new NamedValueTokenParser(null, "output.all.result.luis.json", "11011", "1;0", "true;false", null, "true"),
            new NamedValueTokenParser(null, "output.each.result.luis.json", "11011", "1;0", "true;false", null, "true"),

            new NamedValueTokenParser(null, "output.all.recognizer.recognized.result.entity.json", "1000011", "1;0", "true;false", null, "true"),
            new NamedValueTokenParser(null, "output.each.recognizer.recognized.result.entity.json", "1100011", "1;0", "true;false", null, "true"),

            new NamedValueTokenParser(null, "output.all.result.entity.json", "11011", "1;0", "true;false", null, "true"),
            new NamedValueTokenParser(null, "output.each.result.entity.json", "11011", "1;0", "true;false", null, "true"),
