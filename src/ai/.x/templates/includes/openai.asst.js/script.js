...
import { {ClassName} } from './OpenAIAssistantsCodeInterpreterStreamingClass';
{{else if {_IS_OPENAI_ASST_FILE_SEARCH_TEMPLATE}}}
import { {ClassName} } from './OpenAIAssistantsFileSearchStreamingClass';
{{else if {_IS_OPENAI_ASST_STREAMING_TEMPLATE}}}
import { {ClassName} } from './OpenAIAssistantsStreamingClass';
{{else}}
import { {ClassName} } from './OpenAIAssistantsClass';
{{endif}}
