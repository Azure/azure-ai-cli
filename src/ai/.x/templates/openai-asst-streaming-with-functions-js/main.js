...
async function main() {
  ...
  const assistant = useAzure
    ? <#= ClassName #>.createUsingAzure(azureOpenAIAPIVersion, azureOpenAIEndpoint, azureOpenAIKey, azureOpenAIChatDeploymentName, openAIAssistantId, factory)
    : <#= ClassName #>.createUsingOpenAI(openAIKey, openAIOrganization, openAIAssistantId, factory);
