...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        <#= ClassName #> chat = new <#= ClassName #>(openAIAPIKey, openAIEndpoint, openAIChatDeployment, openAISystemPrompt, azureSearchEndpoint, azureSearchIndexName, azureSearchAPIKey, azureSearchEmbeddingsDeploymentName);
