...
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ OpenAIClient w/ AI Hub  
| P1 | 4 | x |   |  ⏹️ `ai wizard`: Chat (OpenAI) Quickstart  
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) - Step 1: Initialize  
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) - Step 2: Interact/chat  
| P2 |16 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) - Step 3: Generate code (python) 
| P2 |16 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) - Step 3: Generate code (C#) 
...
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your prompt w/ OpenAIClient w/ AI Hub  
| P1 | 4 | x |   |  ⏹️ `ai wizard`: Chat (OpenAI) w/ your prompt Quickstart  
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your prompt - Step 1: Initialize  
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your prompt - Step 2: Interact/chat  
| P2 | 8 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your prompt - Step 3: Generate code (python)
| P2 | 4 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your prompt - Step 3: Generate code (C#)
...
| P1 | 4 | x |   |  ⏹️ `ai wizard`: Chat (OpenAI) w/ your data Quickstart  
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your data - Step 1: Initialize  
| P1 | 2 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your data - Step 2: Interact/chat  
| P2 | 8 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your data - Step 3: Generate code (python)
| P2 | 4 |???|???|  ⏹️ `ai wizard`: Chat (OpenAI) w/ your data - Step 3: Generate code (C#)
...
| P1 | ! |???|???|  ⏹️ PM: studio: integration plan with studio (needs breakdown)  
| P1 | ! |???|???|  ⏹️ PM: vscode: integration plan with hosted VS Code plans (needs breakdown)  
|    | ! |???|???|  ⏹️ PM: cloud shell: how to get it here almost by default if not default
| P1 | ! |???|???|  ⏹️ PM: nuget: how to publish to nuget with the correct owner (same as az-cli)  
