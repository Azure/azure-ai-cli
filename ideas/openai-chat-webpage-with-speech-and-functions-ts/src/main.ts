...
const chat = azureOk
    ? new OpenAIChatCompletionsFunctionsStreamingClass(AZURE_OPENAI_CHAT_DEPLOYMENT, updatedPrompt, openai, factory)
    : new OpenAIChatCompletionsFunctionsStreamingClass(OPENAI_MODEL_NAME, updatedPrompt, openai, factory);
