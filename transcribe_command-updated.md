## src\extensions\speech_extension\commands\transcribe_command.cs
...
namespace Azure.AI.Details.Common.CLI
{
    public class TranscribeCommand : Command
    {
        ...
        private void ProcessResponse(string jsonResponse)
        {
            ...
            var texts = json.GetProperty("combinedPhrases").EnumerateArray().Select(p => p.GetProperty("text").GetString()).ToArray();
            var text = string.Join("\n\n", texts);

            if (Program.Debug) Console.WriteLine(text);
